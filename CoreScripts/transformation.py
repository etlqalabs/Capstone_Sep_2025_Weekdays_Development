...
class DataTransformation:
    ...
    def transform_filter_sales_data(self):
        ...
        try:
            ...
            df.to_sql("intermediate_filtered_sales", mysql_engine, index=False)
    ...
    def transform_router_sales_data_High_region(self):
        ...
        try:
            ...
            df = pd.read_sql(query, mysql_engine)
            df.to_sql("intermediate_high_sales", mysql_engine, index=False)
    ...
    def transform_router_sales_data_Low_region(self):
        ...
        try:
            ...
            df = pd.read_sql(query, mysql_engine)
            df.to_sql("intermediate_low_sales", mysql_engine, index=False)
    ...
    def transform_aggregator_sales_data(self):
        ...
        try:
            ...
            df = pd.read_sql(query, mysql_engine)
            df.to_sql("intermediate_monthly_sales_summary_source", mysql_engine, index=False)
    ...
    def transform_Joiner_sales_product_stores(self):
        ...
        try:
            ...
            df = pd.read_sql(query, mysql_engine)
            df.to_sql("intermediate_sales_with_details", mysql_engine, index=False)
    ...
    def transform_aggregator_inventory_level(self):
        ...
        try:
            ...
            df = pd.read_sql(query, mysql_engine)
            df.to_sql("intermediate_aggregated_inventory_level", mysql_engine, index=False)
